...
public class SQLArticulosGeneratorFromDBF{
	...
	public SQLArticulosGeneratorFromDBF(String dmlOperationParam, String fileOutputName){
	...
	public void generateFileOutputContent() {
		...
		try {			
			fileReader = new FileReader("C:\\Sergio\\Desarrollo\\Database\\Scripts\\ARTICULO_DBF.TXT");
	...
	public static void main(String[] args) {
		...
		SQLArticulosGeneratorFromDBF sqlUpdate = new SQLArticulosGeneratorFromDBF(DML_UPDATE, "c:\\Sergio\\Desarrollo\\DataBase\\Scripts\\UPDATES_ARTICULOS_DBF.sql");
