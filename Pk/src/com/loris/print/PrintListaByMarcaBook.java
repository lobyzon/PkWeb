...
public class PrintListaByMarcaBook extends AbstractPrint {
	...
	public PrintListaByMarcaBook(List<Articulo> articulos, Printer printer) {
		...
		for (; this.indexArticulo < articulos.size();) {
			...
			// ADD NEW PAGE			
			if(this.pageNum <= 5)
				book.append(new PrintListaByMarcaPage(articulos, indexFrom, indexArticulo, this.pageNum), pf);
			this.pageNum++;
		}
