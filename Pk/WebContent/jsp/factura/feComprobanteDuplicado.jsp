					...
					<table border="0" cellspacing="1" cellpadding="1" width="100%">		
						<tr style="text-align: center"> 
							<td style="text-align: center">
								<birt:viewer id="feDuplicado" title="Factura Electronica" forceOverwriteDocument="true" reportDesign="http://localhost:8080/Pk/report/feLorisDuplicado.rptdesign" width="1050" height="600" format="pdf"></birt:viewer>
							</td>
						</tr>
					</table>
