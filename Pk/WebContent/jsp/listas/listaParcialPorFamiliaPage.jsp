...
<jsp:include page="/jsp/include/arriba.jsp" flush="true"/>
	<table border="0" cellspacing="1" cellpadding="1" width="100%" height="50%">
		<form:form method="POST" commandName="familiaChecks" onsubmit="return confirmImpresion()">							
			<tr>
				<td><form:errors path="checkBoxes" cssClass="error"/></td>
			</tr>
			<c:forEach items="${familias}" var="familia">
				<tr>
					<td class="cout" style="text-align: left;">
						<form:checkbox label="${familia.familiaComboDesc}" value="${familia.codigo}" path="checkBoxes"/>
					</td>
				</tr>
			</c:forEach>
			<tr>
